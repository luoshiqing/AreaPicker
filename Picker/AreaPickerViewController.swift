...
class AreaPickerViewController: UIViewController, UIPickerViewDelegate ,UIPickerViewDataSource {
    ...
    fileprivate func loadSomeView(){
        ...
        titleLabel.textColor = UIColor(red: 67/255.0, green: 203/255.0, blue: 156/255.0, alpha: 1)
        ...
        let bgColorArr = [UIColor.white,UIColor(red: 67/255.0, green: 203/255.0, blue: 156/255.0, alpha: 1)]
        let titleColorsArr = [UIColor(red: 55/255.0, green: 56/255.0, blue: 57/255.0, alpha: 1),UIColor.white]
